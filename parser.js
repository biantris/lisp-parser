...
program = '(* 5 8)' 
console.log(eval(parse(program))); // 40

program = '(if (< 10 20) 10 20)'
console.log(eval(parse(program))); // 10

program = '(begin (define r 3) (* 3.14 (* r r)))'
console.log(eval(parse(program))); // 28.26 or 28.274333882308138

program = '(quote abc)'
console.log(eval(parse(program))); // abc

program = '(* 2 3.14)'
console.log(eval(parse(program))); // 6.28

program = '(car (quote (a b c)))' // a
console.log(eval(parse(program)));

program = '(cdr (quote (a b c)))'
console.log(eval(parse(program))); // (b c)

program = '(cons (quote (a b c)) (quote (d e f)))' // (a b c d e f)
console.log(eval(parse(program)));

program = '(quote HelloWorld)'
console.log(eval(parse(program))); // HelloWorld

program = '((lambda (x y) (cons (car x) y)) (quote (a b)) (quote (c d)))'
console.log(eval(parse(program))); // a c, d